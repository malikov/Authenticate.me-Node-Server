...
var ParseStrategy = require('../lib/strategy');

var MockParsepApp = require('./mocks/parse-app');
var MockParseClient = require('./mocks/parse-client');
...
describe('strategy entry', function(){
    it('should export an function', function(){
        assert.equal(typeof PassportStrategy,"function");
    });
});
