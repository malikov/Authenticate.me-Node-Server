...
Application.prototype.deleteAccount = function deleteApplicationAccount(/* account, [options,] callback */){
  var self = this;
  var args = Array.prototype.slice.call(arguments);
  var account = args.shift();
  var callback = args.pop();
  ...
  //fetch the resource for this account
  var resource = self.dataStore.getResource(account.href, options, require('./Account'));
  
  //pass that resource to datastore.delete
  self.dataStore.deleteResource(resource, callback);
  return; 
}
